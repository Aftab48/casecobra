...
const DesignConfigurator = ({
  ...
  return (
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      <div className="flex flex-col h-[37.5rem] w-full col-span-full lg:col-span-1 bg-white ">
        <ScrollArea className="flex-1 relative overflow-auto">
          ...
          <div className="px-8 pb-12 pt-8">
            <h2 className="tracking-light font-bold text-3xl">
              Customize your case
            </h2>
                ...
                <div className="relative flex flex-col gap-3 w-full">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      ...
                      >
                        {options.model.label}
                        <ChevronsUpDown className="w-4 shrink-0 ml-2 opacity-50 h-4" />
                      </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent>
